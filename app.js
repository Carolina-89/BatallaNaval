	...
	processGuess: function(location) {
		if (location) {
			...
			if (hit && model.shipsSunk === model.numShips) {
				view.displayMessage("Hundiste todas mis flotas en " + this.guesses + " intentos.");
...
function init() {
	...
	view.displayMessage("Hola, vamos a jugar! Hay tres flotas compuesta por tres barcos cada una");
}
